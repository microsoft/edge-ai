...
| Name                       | Type                                                           | API Version |
|:---------------------------|:---------------------------------------------------------------|:------------|
| dataflowEndpointToEventHub | `Microsoft.IoTOperations/instances/dataflowEndpoints`          | 2026-07-01  |
| dataflowToEventHub         | `Microsoft.IoTOperations/instances/dataflowProfiles/dataflows` | 2026-07-01  |
...
| Name                        | Type                                                           | API Version |
|:----------------------------|:---------------------------------------------------------------|:------------|
| dataflowEndpointToEventGrid | `Microsoft.IoTOperations/instances/dataflowEndpoints`          | 2026-07-01  |
| dataflowToEventGrid         | `Microsoft.IoTOperations/instances/dataflowProfiles/dataflows` | 2026-07-01  |
...
| Name          | Type                                                                | API Version |
|:--------------|:--------------------------------------------------------------------|:------------|
| dataflowGraph | `Microsoft.IoTOperations/instances/dataflowProfiles/dataflowGraphs` | 2026-07-01  |
...
| Name     | Type                                                           | API Version |
|:---------|:---------------------------------------------------------------|:------------|
| dataflow | `Microsoft.IoTOperations/instances/dataflowProfiles/dataflows` | 2026-07-01  |
