...
resource aioInstanceResource 'Microsoft.IoTOperations/instances@2026-07-01' existing = {
  name: aioInstanceName
}

resource aioDataflowProfileResource 'Microsoft.IoTOperations/instances/dataflowProfiles@2026-07-01' existing = {
  parent: aioInstanceResource
  name: aioDataflowProfileName
}

resource dataflowEndpointToEventGrid 'Microsoft.IoTOperations/instances/dataflowEndpoints@2026-07-01' = {
...
resource dataflowToEventGrid 'Microsoft.IoTOperations/instances/dataflowProfiles/dataflows@2026-07-01' = {
