...
| admin\_password\_wo\_version               | Version used to trigger updates for write-only administrator password arguments. Increment this value when rotating the administrator password. | `number`                                                   | `1`                                                                  |    no    |
