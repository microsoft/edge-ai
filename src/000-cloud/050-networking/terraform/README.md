...
| [external_external.deployment_client_ip](https://registry.terraform.io/providers/hashicorp/external/latest/docs/data-sources/external)                                              | data source |
...
| network\_security\_perimeter | ./modules/network-security-perimeter | n/a     |
...
| existing\_resource\_group\_name                              | Resource group name containing the existing virtual network when use\_existing\_virtual\_network is true. Otherwise, the resource\_group input's name | `string`                                                                | `null`                                                                           |    no    |
...
| network\_security\_group\_name                               | Name of the network security group to create or reference. Otherwise, 'nsg-{resource\_prefix}-{environment}-{instance}'                               | `string`                                                                | `null`                                                                           |    no    |
| network\_security\_perimeter\_allowed\_ip\_address\_prefixes | Additional IPv4 or IPv6 CIDR prefixes allowed through the Network Security Perimeter; the detected deployment client IP is added automatically        | `list(string)`                                                          | `[]`                                                                             |    no    |
...
| should\_use\_network\_security\_perimeter                    | Whether to create a Network Security Perimeter that allows the detected deployment client IP for supported PaaS resources                             | `bool`                                                                  | `false`                                                                          |    no    |
| subnet\_name                                                 | Name of the subnet to create or reference. Otherwise, 'snet-{resource\_prefix}-{environment}-{instance}'                                              | `string`                                                                | `null`                                                                           |    no    |
| use\_existing\_virtual\_network                              | Whether to reference an existing virtual network, subnet, and network security group instead of creating new ones                                     | `bool`                                                                  | `false`                                                                          |    no    |
...
| virtual\_network\_name                                       | Name of the virtual network to create or reference. Otherwise, 'vnet-{resource\_prefix}-{environment}-{instance}'                                     | `string`                                                                | `null`                                                                           |    no    |
...
| network\_security\_perimeter | The Network Security Perimeter and profile used to secure supported PaaS resources |
