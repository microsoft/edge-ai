...
| [azurerm_storage_account.notification](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/storage_account)                                 | resource    |
...
| storage\_account                | Storage account for event session state tracking via Table Storage. Otherwise, creates a new storage account                                                              | ```object({ id = string name = string })```                   | `null`                      |    no    |
