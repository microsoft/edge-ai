...
locals {
  ...
  server_root_ca_cert         = base64encode(file("${path.module}/../../../certs/server-root-ca.crt"))
  server_intermediate_ca_cert = base64encode(file("${path.module}/../../../certs/server-intermediate-ca.crt"))
  server_leaf_ca_cert         = base64encode(file("${path.module}/../../../certs/server-leaf-ca.crt"))
  server_leaf_ca_key          = base64encode(file("${path.module}/../../../certs/server-leaf-ca.key"))

  client_root_ca_cert         = base64encode(file("${path.module}/../../../certs/client-root-ca.crt"))
  client_intermediate_ca_cert = base64encode(file("${path.module}/../../../certs/client-intermediate-ca.crt"))
  client_leaf_ca_cert         = base64encode(file("${path.module}/../../../certs/client-leaf-ca.crt"))
  client_leaf_ca_key          = base64encode(file("${path.module}/../../../certs/client-leaf-ca.key"))
