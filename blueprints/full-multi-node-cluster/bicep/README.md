...
| adminPassword                                    | Password used for the host VM. (Required when not targeting pre-existing Arc machines)                                                                                                                                                                                                                                                                                                                                                                     | `securestring`                                       | n/a                                                                                                                                      | no       |
| hostMachineCount                                 | The number of host VMs to create for the cluster. (The first host VM will be the cluster server)                                                                                                                                                                                                                                                                                                                                                           | `int`                                                | 1                                                                                                                                        | no       |
| shouldUseArcMachines                             | Whether to target pre-existing Azure Arc-enabled machines instead of creating host VMs.                                                                                                                                                                                                                                                                                                                                                                    | `bool`                                               | `false`                                                                                                                                  | no       |
| arcMachineCount                                  | The number of pre-existing Arc-enabled machines to target. (The first Arc machine will be the cluster server)                                                                                                                                                                                                                                                                                                                                              | `int`                                                | 1                                                                                                                                        | no       |
| arcMachineNamePrefix                             | The name prefix for the pre-existing Arc-enabled machines. Machines are resolved as "{prefix}{1..N}". Defaults to the resource prefix.                                                                                                                                                                                                                                                                                                                     | `string`                                             | n/a                                                                                                                                      | no       |
| arcMachineName                                   | The exact name of a single pre-existing Arc-enabled machine. (Honored only when arcMachineCount is 1; overrides the prefix model)                                                                                                                                                                                                                                                                                                                          | `string`                                             | n/a                                                                                                                                      | no       |
| arcMachineResourceGroupName                      | The resource group name containing the pre-existing Arc-enabled machines. Defaults to the deployment resource group.                                                                                                                                                                                                                                                                                                                                       | `string`                                             | n/a                                                                                                                                      | no       |
| clusterServerHostMachineUsername                 | Username for the cluster server host machine that receives kube-config settings on setup. Defaults to the resource prefix.                                                                                                                                                                                                                                                                                                                                 | `string`                                             | n/a                                                                                                                                      | no       |
| clusterServerIp                                  | The IP address for the cluster server. (Required for multi-node Arc clusters; derived from the host VM for VM-based clusters)                                                                                                                                                                                                                                                                                                                              | `string`                                             | n/a                                                                                                                                      | no       |
...
| shouldEnableObservabilityPrivateEndpoints        | Override for Azure Monitor (observability) private endpoints. Defaults to shouldEnablePrivateEndpoints when null. Set false for Arc edge clusters where the managed Prometheus metrics addon cannot fetch its config or ingest over private link and would otherwise leave dashboards empty.                                                                                                                                                               | `bool`                                               | n/a                                                                                                                                      | no       |
...
| networkSecurityPerimeterAllowedIpAddressPrefixes | IPv4 or IPv6 CIDR prefixes allowed through the Network Security Perimeter. Defaults to the published [operations experience](https://iotoperations.azure.com) outbound IPs, see [Troubleshoot the operations experience and private endpoints](https://learn.microsoft.com/azure/iot-operations/troubleshoot/troubleshoot#troubleshoot-the-operations-experience-and-private-endpoints). Must be non-empty when shouldUseNetworkSecurityPerimeter is true. | `string[]`                                           | ['48.211.120.64/32', '72.145.25.40/32', '128.24.193.24/32', '72.145.132.248/32', '57.154.126.80/32']                                     | no       |
...
| shouldDeployNotification                         | Whether to deploy the 045-notification Logic App for alert deduplication and Teams posting.                                                                                                                                                                                                                                                                                                                                                                | `bool`                                               | `false`                                                                                                                                  | no       |
| alertEventHubName                                | Name of the Event Hub for inference alerts. Otherwise, 'evh-{resourcePrefix}-alerts-{environment}-{instance}'.                                                                                                                                                                                                                                                                                                                                             | `string`                                             | [format('evh-{0}-alerts-{1}-{2}', parameters('common').resourcePrefix, parameters('common').environment, parameters('common').instance)] | no       |
| notificationEventSchema                          | JSON schema object for parsing Event Hub events in the Logic App Parse_Event action.                                                                                                                                                                                                                                                                                                                                                                       | `object`                                             | {}                                                                                                                                       | no       |
| notificationMessageTemplate                      | HTML template for new-event Teams notifications. Supports the `${close_session_url}` placeholder and Logic App expression syntax for dynamic event fields.                                                                                                                                                                                                                                                                                                 | `string`                                             | <p>New alert event detected.</p>                                                                                                         | no       |
| closureMessageTemplate                           | HTML message body for session-closure Teams notifications. Supports Logic App expression syntax for dynamic fields.                                                                                                                                                                                                                                                                                                                                        | `string`                                             | <p>Session closed for event.</p>                                                                                                         | no       |
| notificationPartitionKeyField                    | Event schema field name used as the Table Storage partition key for session state deduplication lookups.                                                                                                                                                                                                                                                                                                                                                   | `string`                                             | event_id                                                                                                                                 | no       |
| teamsRecipientId                                 | Teams chat or channel thread ID for posting event notifications.                                                                                                                                                                                                                                                                                                                                                                                           | `securestring`                                       |                                                                                                                                          | no       |
...
| cloudNotification     | `Microsoft.Resources/deployments` | 2025-04-01  |
...
| shouldCreateBlobDnsZone          | Create the shared blob private DNS zone (consumed by the storage account component) independently of the Azure Monitor private endpoints. Lets callers keep the blob zone when monitor private endpoints are disabled. | `bool`                             | `false`                                                                                                                                                                                                                                                                                                                                               | no       |
| telemetry_opt_out                | Whether to opt out of telemetry data collection.                                                                                                                                                                       | `bool`                             | `false`                                                                                                                                                                                                                                                                                                                                               | no       |
...
#### Parameters for cloudNotification
...
#### Resources for cloudNotification
