...
| notification\_partition\_key\_field | Event schema field name used as the Table Storage partition key for session state deduplication lookups | `string` | `"camera_id"` | no |
