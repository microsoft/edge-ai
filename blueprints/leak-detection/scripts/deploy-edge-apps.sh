...
##############################################################################
# Deploy Edge Apps — ONVIF Simulator, 509, 507, 503
##############################################################################
#
# DESCRIPTION:
#   Deploys all edge applications to the Arc-connected cluster.
...
CHARTS_DIR="${TF_BLUEPRINT_DIR}/services/onvif-camera-simulator/charts"
...
# Step 2 — Deploy 509 (Kustomize)
echo "=== Step 2: Deploying 509-sse-connector ==="
...
# Step 4 — Create ACSA PVC
echo "=== Step 4: Creating ACSA PVC ==="
kubectl apply -f - <<EOF
apiVersion: v1
...
# Step 5 — Create ACSA EdgeSubvolume
echo "=== Step 5: Creating ACSA EdgeSubvolume ==="
kubectl apply -f - <<EOF
...
# Step 6 — Deploy 503 (Helm)
echo "=== Step 6: Deploying 503-media-capture-service ==="
