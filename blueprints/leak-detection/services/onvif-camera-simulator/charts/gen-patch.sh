...
##############################################################################
# ONVIF Camera Simulator - Kustomize Patch Generator
##############################################################################
#
# DESCRIPTION:
#   Generates Kustomize deployment patches for the ONVIF Camera Simulator
#   service based on current environment configuration. Creates patch files
#   that modify container images and namespace settings for Kubernetes
#   deployments.
#
# USAGE:
...
#   --image-name <name>     Image name (default: onvif-camera-simulator)
...
IMAGE_NAME="${IMAGE_NAME:-onvif-camera-simulator}"
