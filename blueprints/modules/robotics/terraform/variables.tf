...
variable "redis_access_keys_authentication_enabled" {
  type        = bool
  description = "Whether to enable access key authentication for Redis"
  default     = false
}
...
variable "should_install_robotics_charts" {
  type        = bool
  description = "Whether to install robotics-specific charts (NVIDIA related charts)."
  default     = false
}

variable "should_install_azureml_charts" {
  type        = bool
  description = "Whether to install AzureML-specific charts."
  default     = false
}
