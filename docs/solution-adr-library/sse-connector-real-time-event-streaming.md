...
- [Blueprint Configuration Example](https://github.com/microsoft/edge-ai/blob/main/blueprints/full-multi-node-cluster/terraform/sse-connector-assets.tfvars.example)
