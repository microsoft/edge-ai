...
This repository currently targets the **AIO 2607** release. The table below maps `az iot ops` CLI versions to the component versions pinned in edge-ai:
...
- `azure-iot-ops` CLI extension installed (this repo expects version `2.8.0`).
