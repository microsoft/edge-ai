...
## [5.0.0](https://github.com/microsoft/edge-ai/compare/v4.0.3...v5.0.0) (2026-09-18)


### ⚠ BREAKING CHANGES

* **terraform:** upgrade AzureRM provider to v5.3.0 ([#785](https://github.com/microsoft/edge-ai/issues/785))
...
* **iot-ops:** upgrade Azure IoT Operations to 2608 (v1.4.73) with OPC UA connector support ([#796](https://github.com/microsoft/edge-ai/issues/796)) ([aae1e03](https://github.com/microsoft/edge-ai/commit/aae1e035864f8142390f5de33a0cc5a7262a64e4))
...
* **application:** patch rustls advisory RUSTSEC-2026-0285 ([#809](https://github.com/microsoft/edge-ai/issues/809)) ([88a2876](https://github.com/microsoft/edge-ai/commit/88a2876a7358aeddae3aa1f3d9936a2323134fc3))
...
* **build:** refresh Python dependencies and unblock security CI ([#794](https://github.com/microsoft/edge-ai/issues/794)) ([44c9350](https://github.com/microsoft/edge-ai/commit/44c935043875d1afea2f6634b8fa2b9892ca0215))
...
* **build:** retry transient Grype download failures ([#813](https://github.com/microsoft/edge-ai/issues/813)) ([d040682](https://github.com/microsoft/edge-ai/commit/d040682a3e3e89fac0b547ed09e7bd52815f6f58))
* **build:** update Python dependencies without upgrading Checkov ([#811](https://github.com/microsoft/edge-ai/issues/811)) ([4ac64a7](https://github.com/microsoft/edge-ai/commit/4ac64a7e3917ef261ce18fe2f7aba9ce09351907))
...
* **deps-dev:** bump browserslist from 4.28.2 to 4.28.8 in /src/500-application/513-tiered-notification-service ([#790](https://github.com/microsoft/edge-ai/issues/790)) ([7fc6d33](https://github.com/microsoft/edge-ai/commit/7fc6d3393fef44726e0adcac20bd4e4672c46f45))
...
* **deps:** bump @humanfs/node from 0.16.7 to 0.16.8 ([#789](https://github.com/microsoft/edge-ai/issues/789)) ([0e3eff3](https://github.com/microsoft/edge-ai/commit/0e3eff32bedade2527f628854687ae6cfe9cd2c9))
* **deps:** bump @vitest/mocker, @vitest/coverage-v8 and vitest in /src/500-application/516-chat-with-your-factory/services/chat-with-your-factory ([#802](https://github.com/microsoft/edge-ai/issues/802)) ([2cfd049](https://github.com/microsoft/edge-ai/commit/2cfd049867331b3d8844bc6ca6a6d4481dd402db))
...
* **deps:** bump fast-uri from 3.1.5 to 3.1.7 in /docs/docusaurus ([#787](https://github.com/microsoft/edge-ai/issues/787)) ([9248c1f](https://github.com/microsoft/edge-ai/commit/9248c1f1b3b311450da6afc9c9dc668949b7717e))
* **deps:** bump github.com/microsoftgraph/msgraph-sdk-go from 1.101.0 to 1.102.0 in /blueprints/full-multi-node-cluster/tests in the gomod group across 1 directory ([#793](https://github.com/microsoft/edge-ai/issues/793)) ([9b75556](https://github.com/microsoft/edge-ai/commit/9b755564456ece7e5decbc671781bb4c49d5afec))
...
* **deps:** bump gitpython from 3.1.58 to 3.1.59 in /.github/requirements ([#798](https://github.com/microsoft/edge-ai/issues/798)) ([8cec3c7](https://github.com/microsoft/edge-ai/commit/8cec3c7d759583a3781258f7431a02df822b98c5))
...
* **deps:** bump qs from 6.15.3 to 6.16.0 in /src/500-application/516-chat-with-your-factory/services/chat-with-your-factory ([#788](https://github.com/microsoft/edge-ai/issues/788)) ([1858a5c](https://github.com/microsoft/edge-ai/commit/1858a5c713d78d8017c5b43556f8f5fe439b5b1d))
...
* **deps:** bump soupsieve from 2.8.4 to 2.9 ([#814](https://github.com/microsoft/edge-ai/issues/814)) ([a7eaf6a](https://github.com/microsoft/edge-ai/commit/a7eaf6ac00b728541f58ab94a7349aa73c5463a7))
...
* **deps:** bump the github-actions group across 1 directory with 8 updates ([#806](https://github.com/microsoft/edge-ai/issues/806)) ([af2f165](https://github.com/microsoft/edge-ai/commit/af2f16527f06c176dfbd5a4aaa9add78f6e5e0b7))
...
* **deps:** bump the npm group across 2 directories with 4 updates ([#792](https://github.com/microsoft/edge-ai/issues/792)) ([dbd4581](https://github.com/microsoft/edge-ai/commit/dbd4581514e5a0d1da823e397af971e68ead0f94))
* **deps:** bump the npm group across 2 directories with 6 updates ([#810](https://github.com/microsoft/edge-ai/issues/810)) ([092ef90](https://github.com/microsoft/edge-ai/commit/092ef9003ad4cc89cbb15a35fcd9b5d4bc245d14))
...
* **terraform:** upgrade AzureRM provider to v5.3.0 ([#785](https://github.com/microsoft/edge-ai/issues/785)) ([1c5ad02](https://github.com/microsoft/edge-ai/commit/1c5ad02c23412cd2dd3e33da9284602928fd6e5b))
