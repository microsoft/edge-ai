...
.EXAMPLE
    pwsh -File scripts/learning/Generate-LearningCatalog.ps1 -LearningRoot "C:\Projects\edge-ai\learning"
...
function Format-CatalogMarkdown {
    ...
    $markdown += "author: Edge AI Team`n"
...
function Format-PathsReadme {
    ...
    $markdown += "description: Pre-curated learning paths for edge AI development`n"
    $markdown += "author: Edge AI Team`n"
    $markdown += "ms.date: $(Get-Date -Format 'yyyy-MM-dd')`n"
    $markdown += "ms.topic: hub-page`n"
    $markdown += "keywords:`n"
