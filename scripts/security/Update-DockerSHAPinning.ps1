...
$DockerImageSHAMap = @{
    ...
    'mcr.microsoft.com/devcontainers/python:3.12-bookworm' = 'mcr.microsoft.com/devcontainers/python:3.12-bookworm@sha256:2edef5225f54e5f0d54346246c69536daa16a455ebf82fdfd4542d0a878ef660'
