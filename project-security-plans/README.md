...
For infrastructure blueprints in this repository, use the Security Planner provided by the [hve-core](https://github.com/microsoft/hve-core) VS Code extension to generate comprehensive security plans:
...
1. Select the HVE Core Security Planner custom agent in GitHub Copilot
