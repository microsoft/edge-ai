...
description: 'Required instructions for learning path content including path YAML requirements, double checkbox navigation pattern, and progressive difficulty ordering - Brought to you by microsoft/edge-ai'
---
...
- **author**: Author name or "Edge AI Team"
...
3. **Expert Practitioner** (`difficulty: expert`)
   ...
   - **Example**: "Edge AI Systems", "Full-Stack AI Integration"
...
3. **Example Learning Paths**:
   ...
   - `learning/paths/expert-edge-ai-systems.md` - Expert-level path example
