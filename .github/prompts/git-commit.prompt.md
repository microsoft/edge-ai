...
```markdown
feat: add repo-wide instruction files including prompts and custom agents

* add commit message, markdown, C# along with C# test instructions
* introduce task planner and researcher, prompt builder, and adr creation custom agents
