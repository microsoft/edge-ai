...
- You WILL NEVER add anything to the `${input:prompt}` that should go into the report (clarifying instructions, step-by-step plans, highlighting inconsistencies, etc.).
...
- You WILL create and maintain a detailed report file throughout the process.
- You WILL update the report file after EACH and EVERY change.
- You WILL review the report after each change to verify correctness.
- You WILL finalize the report with a summary and issues section.
- You WILL delete the report file when the refactoring is complete.
...
1. **Plan File Creation**:
   - You WILL create a report file in `.copilot-tracking/reports/` folder.
   - The filename WILL follow the pattern `${name_of_input_prompt_file}.report.md`.
   - You WILL ensure this report file exists and only append to it if it already exists.

2. **Initial Plan Development**:
   - You WILL update the report file with step-by-step details on your approach.
...
4. **Iterative Implementation**:
   - You WILL add a section to the report titled "Changes Made - Iteration {{number}}".
...
5. **Final Verification**:
   - You WILL review the entire report to ensure all changes were made correctly.
   ...
   - You WILL delete the report file once all changes are complete and verified.

## Refactoring Process

<!-- <process> -->

1. **Report File Creation and Initial Setup**:
   1.1. Create a report file in `.copilot-tracking/reports/` using the pattern `${name_of_input_prompt_file}.report.md`.
   1.2. Ensure this report file exists. If it does not exist, create it. If it already exists, continue from the existing report.
   1.3. Add only to this report. If the report already exists, add new sections or update existing ones without removing prior content.
...
3. **Plan Finalization Before Implementation**:
   3.1. Add a section to the report: "Changes Made - Iteration 1".
...
5. **Final Verification and Cleanup**:
   ...
   5.5. Delete the report file when all changes are complete and verified.
...
1. First, create and update the report file:
   ```
   I've created a report file at `.copilot-tracking/reports/terraform-standards.prompt.md.report.md` and documented the analysis of the current document.
   ```

2. After planning the refactoring approach:
   ```
   I've updated the report with a detailed plan for refactoring, focusing on reorganizing the structure and standardizing prompting terminology.
   ```
...
5. At completion:
   ...
   I've deleted the report file as all changes are now complete.
   ```
<!-- </example-implementation> -->
