...
```json
{
  "metadata": {
    ...
    "source": "coach",
    "pathId": "lab-focused-edge-ai-systems-2025-01-16",
    "sessionId": "generated-session-id",
    "createdBy": "lab-coach",
    "lastModified": "2025-01-16T10:30:00Z"
  },
  "learningPath": {
    "id": "lab-focused-edge-ai-systems-2025-01-16",
    "title": "Edge AI Systems Integration Mastery",
    ...
    "components": [
      ...
      },
      {
        ...
        "labs": [
          {
            "id": "edge-ai-integration-lab-01",
            "title": "Edge AI Integration Lab",
            "filePath": "learning/training-labs/edge-ai/01-integration-lab.md",
            "estimatedTime": "8-12 hours",
            "difficulty": "intermediate",
            "collaborationLevel": "team-based",
...
1. **Sequence Context**: "You're working on the foundation katas to prepare for the edge AI integration lab. This skill will be essential for [specific lab module]."
...
```text
**Your Lab-Focused Learning Path: Edge AI Systems Integration Mastery**
...
4. ⬜ Edge AI Integration Lab (8-12 hours)
...
**Path**: Edge AI Systems Integration Mastery
...
**Phase 2 In Progress** 🔄:
- Edge AI Integration Lab (Module 2 of 4)
...
- **Scenario Mapping**: "Use edge-ai-project-planner to understand how your lab architecture applies to [industry scenario]"
...
- "The architecture you built in this lab maps well to [industry scenario]. Use edge-ai-project-planner to explore production applications."
