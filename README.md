...
* Proposed - for all ADRs that have been reviewed by the ADR sign-off team (project leads), this phase indicates the ADR is open for discussion amongst the broad community for feedback.
* Accepted - for all ADRs that have completed the community RFC process. ADRs in this have been ratified/accepted by the project community and may move to implementation.
...
Please see [ADR README](./ADRs/README.MD) for more detailed explanation of process flow and how to author and progress your ideas for this project through to implementation.
