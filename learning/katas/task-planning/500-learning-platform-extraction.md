---
title: 'Kata: 500 - Learning Platform Extraction'
description: Learn comprehensive extraction and packaging of documentation frameworks and learning platform capabilities for client project delivery...
author: Edge AI Team
ms.date: 2025-06-21
kata_id: task-planning-500-learning-platform-extraction
kata_category:
  - task-planning
kata_difficulty: 5
estimated_time_minutes: 180
learning_objectives:
  - Learn learning platform analysis and extraction techniques
  - Develop systematic knowledge asset identification skills
  - Create comprehensive learning resource organization systems
prerequisite_katas:
...
technologies:
  ...
  - Docsify
success_criteria:
  - Complete learning platform analysis
  - Extract and organize knowledge assets
  - Implement learning resource management system
ai_coaching_level: guided
scaffolding_level: light
hint_strategy: progressive
common_pitfalls:
  - 'Incomplete framework analysis: Always analyze both documentation and learning systems together'
  - 'Missing client customization: Plan for business-specific terminology and branding'
...
**You'll Learn**: Learn comprehensive extraction and packaging of documentation frameworks and learning platform capabilities for complete client capability transfer.
...
**Real Challenge**: Enterprise clients need your proven learning and documentation systems integrated into their projects. This kata teaches systematic extraction and packaging of complete learning platforms - from documentation frameworks to kata systems - enabling clients to maintain your learning and development methodologies in their environment.
...
**Quick Validation**: Verify you can access GitHub Copilot Chat with Task Planner mode, navigate to `docs/` and `learning/` folders, and run `npm run docs`.

**Understanding Check**: This kata teaches complete learning platform extraction and client integration - from documentation frameworks to kata systems - using the systematic planning-to-implementation workflow for Tailspin Toys' Edge Insights project.
...
**What You'll Do**: Package learning platform capabilities and plan client-specific customizations

**Steps**:

1. **Package** learning platform assets
   - [ ] Navigate through `learning/` structure and catalog all learning components
...
Before moving forward, validate your understanding:

- Can you explain the difference between documentation framework extraction and learning platform packaging?
- How would you adapt your integration script from AI Asset Extraction kata to handle documentation frameworks and learning platforms?
- What business context customizations are essential for Tailspin Toys' Edge Insights platform?
- How do you validate that a complete learning platform transfer is ready for client integration?
...
- **Extend Existing Scripts**: Build on your AI Asset Extraction script rather than starting from scratch - add documentation and learning platform support incrementally
- **Test Documentation Builds**: Always test documentation framework integration in isolation before combining with learning platform to isolate build issues
- **Preserve Client Branding**: Design integration scripts to maintain client visual identity and terminology while adding Edge-AI capabilities
- **Business Context First**: Customize learning content with client-specific scenarios before packaging to ensure relevance and immediate value
- **Comprehensive Validation**: Create validation checklists for documentation framework, learning platform, and integration script components separately
- **Version Control Strategy**: Package extraction deliverables in a way that supports future updates and capability additions for long-term client value

### Troubleshooting

- **Documentation Build Conflicts**: If documentation framework integration breaks client builds, isolate the navigation system first - merge `_sidebar.md` and `_navbar.md` manually to understand conflicts before automating
- **Learning Platform Customization Issues**: When business context customization feels overwhelming, start with terminology replacement only - update client platform names and role titles first, then expand to scenario customization
- **Integration Script Complexity**: If integration script grows too complex, break into three separate scripts (documentation framework, learning platform, validation) with a main orchestration script for maintainability
