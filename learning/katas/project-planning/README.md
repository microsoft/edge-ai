---
title: Project Planning Katas
description: Progressive practice exercises for developing expertise in Edge AI project planning using the interactive project planner and documentation templates
author: Edge AI Team
ms.date: 2025-07-21
...
real_world_application: |
  - Manufacturing predictive maintenance project planning and scoping
  - Edge AI deployment roadmap creation for operations optimization
  - Multi-scenario planning for enterprise edge AI rollouts
  - Capability mapping and technical requirements documentation
...
common_pitfalls:
  - "Insufficient scenario detail": Include specific business context and technical constraints
  - "Weak capability mapping": Clearly connect business requirements to technical Edge AI capabilities
  - "Poor prompt formulation": Use specific, detailed prompts for better planning guidance
# SEO & Discoverability
keywords:
  - learning
  - project planning
...
extension_challenges:
  - challenge_name: Multi-Project Portfolio Planning
    description: Plan comprehensive edge AI portfolio across multiple business units with interdependencies
    difficulty: advanced
    estimated_time: 90 minutes
  - challenge_name: Stakeholder Alignment Workshop
    description: Facilitate planning workshop with multiple stakeholders using project planner
    difficulty: expert
...
|-----|-------------------------------------------------------------------------------------|--------------|----------|-----------------|-----------------------|-------------|
| 100 | [100 - Basic Project Planning Prompt Usage](./100-basic-prompt-usage.md)            | ⭐ Foundation | 30 min   | —               | GitHub Copilot        | Heavy       |
| 300 | [300 - Comprehensive Two-Scenario Planning](./300-comprehensive-two-scenario.md)    | ⭐⭐⭐ Advanced | 90 min   | → 100           | GitHub Copilot        | Medium      |
| 400 | [400 - Advanced Strategic Planning](./400-advanced-strategic-planning.md)           | ⭐⭐⭐⭐ Expert  | 120 min  | → 100, 300      | GitHub Copilot        | Light       |
| 400 | [400 - Enterprise Architecture Planning](./400-enterprise-architecture-planning.md) | ⭐⭐⭐⭐ Expert  | 150 min  | → 100, 300      | GitHub Copilot, Azure | Light       |
| 400 | [400 - Stakeholder Alignment Strategies](./400-stakeholder-alignment-strategies.md) | ⭐⭐⭐⭐ Expert  | 120 min  | → 100, 300, 400 | GitHub Copilot        | Light       |
...
- **Focus**: Learn basic prompt engineering for project planning and develop structured planning workflows using AI assistance
- **Skills**: GitHub Copilot
- **Time-to-Practice**: Under 1 hour

### 300 - Advanced Level

- **Focus**: Learn multi-scenario project planning by analyzing multiple Edge AI scenarios and creating integrated implementation plans
- **Skills**: GitHub Copilot
- **Time-to-Practice**: 1-2 hours

### 400 - Expert Level

- **Focus**: Learn strategic planning for Edge AI initiatives from proof-of-concept through enterprise scaling and Develop enterprise architecture planning expertise and comprehensive system design with AI assistance for complex Edge AI transformations with multi-facility
- **Skills**: GitHub Copilot, Azure
- **Time-to-Practice**: 7 hours
...
- **Edge AI Project Scoping**: Systematic approach to defining project requirements and scope
- **Scenario-Based Planning**: Matching business needs to proven implementation patterns
- **Capability Analysis**: Understanding platform dependencies and implementation roadmaps
- **Documentation Generation**: Creating comprehensive project documentation using templates

## Prerequisites

- Basic understanding of Edge AI and industrial automation concepts
- Familiarity with VS Code and GitHub Copilot Chat (helpful but not required)
- Ready to engage with hands-on project planning practice
...
- **Documentation quality issues**: Reference existing project examples and templates for structure and detail level

**Tips for Success:**

- Start with clear business context and specific technical constraints
- Use iterative approach - refine scenarios through multiple planning sessions
- Leverage existing scenario templates and examples for guidance
- Focus on concrete business outcomes rather than abstract technical features
...
**Ready to start Edge AI project planning practice?**

🎯 **[Begin with 100 - Basic Prompt Usage][kata-100-basic]**

*Develop systematic Edge AI project planning through streamlined, focused practice.*
...
<!-- Reference Links -->
[kata-100-basic]: ./100-basic-prompt-usage
